...
<body>
                ...
                <li class="nav-item">
                    <button class="btn btn-outline-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                     ...
                     <div class="dropdown-menu form">
                        ...
                        <a class="dropdown-item" href="crear ususario.jsp"><small>Eres nuevo por aqui, crea un usuario</small></a>
                     </div>
                </li>
                <li class="nav-item">
    ...
    <div class="row mt-5">
        <div class="col-md-6">
            <form action="crear usuario.java" method="post">
            <div class="form-group">
                Nombre de usuario
                <input type="nombre de usuario" class="form-control" id="exampleFormControlInput1" placeholder="nombre">
            </div>
            <div class="form-group">
                Contraseña
                <input type="contraseña" class="form-control" id="exampleFormControlInput1" placeholder="contraseña">
            </div>
